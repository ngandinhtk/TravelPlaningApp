...
export const SAMPLE_PLACES_DATA: Place[] = [
  ...
  },
  {
    ...
    province: "Hà Nội",
    description: "Nơi an nghỉ vĩnh hằng của Chủ tịch Hồ Chí Minh, vị lãnh tụ kính yêu của dân tộc Việt Nam, nằm tại quảng trường Ba Đình lịch sử.",
    category: "History",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Ho_Chi_Minh_Mausoleum_-_Hanoi.jpg/800px-Ho_Chi_Minh_Mausoleum_-_Hanoi.jpg",
    rating: 4.8,
  ...
  },
  {
    ...
    province: "Hà Nội",
    description: "Trường đại học đầu tiên của Việt Nam, nơi thờ Khổng Tử và các bậc hiền triết, biểu tượng của tinh thần hiếu học ngàn đời.",
    category: "History",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Khue_Van_Cac_2013.jpg/800px-Khue_Van_Cac_2013.jpg",
    rating: 4.7,
  ...
  },
  {
    name: "Dinh Độc Lập",
    province: "Hồ Chí Minh",
    description: "Di tích lịch sử quốc gia đặc biệt, nơi chứng kiến sự kiện Giải phóng miền Nam, thống nhất đất nước ngày 30/4/1975.",
    category: "History",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Reunification_Palace%2C_Ho_Chi_Minh_City.jpg/800px-Reunification_Palace%2C_Ho_Chi_Minh_City.jpg",
    rating: 4.6,
    address: "Quận 1, TP. Hồ Chí Minh",
  ...
  },
  {
    ...
    province: "Hồ Chí Minh",
    description: "Kiệt tác kiến trúc Roman pha trộn Gothic, biểu tượng của thành phố với hai tháp chuông cao vút và gạch đỏ đặc trưng.",
    category: "Culture",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Notre_Dame_Cathedral_Saigon.jpg/800px-Notre_Dame_Cathedral_Saigon.jpg",
    rating: 4.7,
    address: "Quận 1, TP. Hồ Chí Minh",
  ...
  },
  {
    ...
    province: "Hồ Chí Minh",
    description: "Con phố sầm uất và hiện đại nhất Sài Gòn, nơi diễn ra các hoạt động văn hóa, lễ hội và vui chơi giải trí về đêm.",
    category: "Culture",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Nguyen_Hue_Walking_Street_at_night.jpg/800px-Nguyen_Hue_Walking_Street_at_night.jpg",
    rating: 4.5,
    address: "Quận 1, TP. Hồ Chí Minh",
  ...
  },
  {
    name: "Ngũ Hành Sơn",
    province: "Đà Nẵng",
    description: "Quần thể 5 ngọn núi đá vôi ven biển với nhiều hang động huyền bí và các ngôi chùa cổ kính linh thiêng.",
    category: "Nature",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Marble_Mountains_Da_Nang.jpg/800px-Marble_Mountains_Da_Nang.jpg",
    rating: 4.6,
  ...
  },
  {
    name: "Cầu Rồng",
    province: "Đà Nẵng",
    description: "Cây cầu độc đáo với thiết kế hình con rồng thời Lý, có khả năng phun lửa và phun nước vào các tối cuối tuần.",
    category: "Culture",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Dragon_Bridge_Da_Nang_Night.jpg/800px-Dragon_Bridge_Da_Nang_Night.jpg",
    rating: 4.8,
...
export const searchPlacesViaGoogle = async (query: string, province: string) => {
    ...
    if (json.status === 'OK') {
      return json.results.map((place : any) => {
        ...
        if (province === 'All' && place.formatted_address) {
          ...
          else if (address.includes('Hồ Chí Minh') || address.includes('Ho Chi Minh')) detectedProvince = 'Hồ Chí Minh';
...
const mapGooglePlaceToCategory = (place: any) => {
  ...
  if (name.includes('biển') || name.includes('bãi') || name.includes('vịnh') || name.includes('đảo') || name.includes('hòn') || name.includes('beach') || name.includes('island') || name.includes('bay')) return 'Beach';
  
  if (name.includes('núi') || name.includes('đỉnh') || name.includes('đèo') || name.includes('cao nguyên') || name.includes('mountain') || name.includes('hill')) return 'Mountain';
  
  if (name.includes('chùa') || name.includes('đền') || name.includes('miếu') || name.includes('lăng') || name.includes('tháp') || name.includes('thành') || name.includes('cố đô') || name.includes('temple') || name.includes('pagoda')) return 'History';
